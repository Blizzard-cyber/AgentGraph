    ...
    <div style={{ position: 'relative' }} ref={dropdownRef}>
      <Tooltip title={selectedAgent ? t('components.agentPicker.currentAgent', { agent: selectedAgent }) : t('components.agentPicker.selectAgent')}>
        <Button
          ...
          loading={loading}
          style={{
            color: selectedAgent ? '#1890ff' : 'rgba(0, 0, 0, 0.65)',
            border: 'none',
            background: showPanel || selectedAgent ? 'rgba(24, 144, 255, 0.08)' : 'transparent',
            ...
            padding: 0,
            boxShadow: selectedAgent ? '0 1px 3px rgba(24, 144, 255, 0.15)' : 'none'
          }}
          onMouseEnter={(e) => {
          ...
          onMouseLeave={(e) => {
            e.currentTarget.style.color = selectedAgent ? '#1890ff' : 'rgba(0, 0, 0, 0.65)';
            e.currentTarget.style.background = showPanel || selectedAgent ? 'rgba(24, 144, 255, 0.08)' : 'transparent';
          }}
        />
      </Tooltip>
      ...
      {showPanel && (
        <div style={{
          ...
          borderRadius: '8px',
          boxShadow: '0 8px 24px rgba(24, 144, 255, 0.15), inset 0 1px 0 rgba(255, 255, 255, 0.8)',
          zIndex: 1000,
          overflow: 'hidden'
        }}>
          {/* 顶部装饰线 */}
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: selectedAgent === agent.name
                      ? '0 2px 6px rgba(24, 144, 255, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.9)'
                      : '0 1px 2px rgba(24, 144, 255, 0.04)',
                    marginBottom: '6px'
                  }}
                  onMouseEnter={(e) => {
                    if (selectedAgent !== agent.name) {
                      e.currentTarget.style.background = 'rgba(230, 244, 255, 0.8)';
